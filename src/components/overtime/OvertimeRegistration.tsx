        ...
        days.push(
            <div 
                ...
                className={`h-16 md:h-32 border p-1 md:p-2 relative transition-all cursor-pointer group flex flex-col 
                  ${isToday ? 'bg-indigo-50/40 ring-inset ring-1 ring-indigo-500/30' : (isMyDutyDay ? 'bg-red-50/10' : 'bg-white hover:bg-slate-50')} 
                  ${isMyDutyDay ? 'ring-2 ring-red-500 border-red-500 shadow-[0_0_12px_rgba(239,68,68,0.4)] hover:shadow-[0_0_16px_rgba(239,68,68,0.55)] z-10' : 'border-slate-100'}
