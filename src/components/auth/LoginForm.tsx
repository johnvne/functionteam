...
export const LoginForm: React.FC<LoginFormProps> = ({ onLoginSuccess }) => {
  ...
  const festiveConfig = useMemo(() => {
    ...
    return {
      bg: 'bg-slate-50',
      gradient: 'from-indigo-100/50 via-white to-purple-100/50',
      card: 'bg-white/90 border-white backdrop-blur-2xl',
      ...
      inputBg: 'bg-slate-50/50 border-slate-200 text-slate-900',
      inputFocus: 'focus:border-indigo-600 focus:ring-indigo-600/10',
  ...
  return (
    <div className={`min-h-screen ${festiveConfig.bg} flex items-center justify-center p-4 transition-all duration-1000 relative overflow-hidden`}>
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-500/5 rounded-full blur-[120px] animate-pulse delay-1000"></div>
